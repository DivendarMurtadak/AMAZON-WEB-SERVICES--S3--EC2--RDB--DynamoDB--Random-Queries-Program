...
public class AmazonDynamoDBSample {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			for (String line = br.readLine(); line != null; line = br
				...
				// Add an item
				Map<String, AttributeValue> item = newItem(iKey, sTemp[0],
						sTemp[1], sTemp[2], sTemp[3], sTemp[4], sTemp[5],
						sTemp[6], sTemp[7], sTemp[8], sTemp[9], sTemp[10],
						sTemp[11], sTemp[12], sTemp[13], sTemp[14], sTemp[15]);
	...
	private static Map<String, AttributeValue> newItem(int Key, String STATION,
			String STATION_NAME, String DATE, String TMAX, String TMIN,
			String TOBS, String WDMV, String AWND, String WDF2, String WDF5,
			String WDFG, String WSF2, String WSF5, String WSFG, String PGTM,
			String FMTM) {
